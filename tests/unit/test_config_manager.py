...
def test_secret_key_min_length_enforced():
    with pytest.raises(ValidationError):
        _isolated(SECRET_KEY="too-short")


def test_secret_key_alias_jwt_secret_key(monkeypatch):
...
def test_smtp_aliases(monkeypatch):
...
def test_validate_startup_prod_rejects_placeholder_secret():
...
def test_validate_startup_prod_rejects_wildcard_cors():
